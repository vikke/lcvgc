...
* [7. クリップ定義 (clip)](#7-クリップ定義-clip)
    ...
    * [7.10 `|` 拍境界スナップ（音程楽器）](#710--拍境界スナップ音程楽器)
    * [7.11 和音（角括弧記法）](#711-和音角括弧記法)
    * [7.12 コード名記法](#712-コード名記法)
    * [7.13 アルペジオ](#713-アルペジオ)
    * [7.14 ドラム（ステップシーケンサー記法）](#714-ドラムステップシーケンサー記法)
        * [ヒット記号](#ヒット記号)
        * [`|` 拍境界スナップ](#-拍境界スナップ)
        * [`>N` 小節ジャンプ](#n-小節ジャンプ)
        * [繰り返し](#繰り返し)
        * [確率行](#確率行)
    * [7.15 CCオートメーション](#715-ccオートメーション)
        * [ステップ方式](#ステップ方式)
        * [時間指定方式](#時間指定方式)
        * [指数カーブ補間](#指数カーブ補間)
        * [両方式の混在](#両方式の混在)
