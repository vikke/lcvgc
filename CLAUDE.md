...
- 調査系以外編集、新規系のpromptはprを作成する。
- まず、 branchの運用で書いたように、brachを作成後、empty commit を作成する。
- prompt から、PRのタイトルに相応しい内容を作成する。
- prompt から、PRのボディに相応しい内容を生成する。
- gh を使って、作成したbranchに対するPRを作成する。
